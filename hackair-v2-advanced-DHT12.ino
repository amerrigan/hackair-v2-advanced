...
// Setup the temperature and humidity sensor (pin D1)
DHT12 dht12;
...
void loop() {
  ...
  float env_temp = dht12.readTemperature();
  float env_hum = dht12.readHumidity();
...
// Measure data
  ...
  if (isnan(h12)) {
    ...
    sensor.humidityCompensation(data, h12);
  }
  }
